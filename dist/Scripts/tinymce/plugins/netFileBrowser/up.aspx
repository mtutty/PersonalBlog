...
<script runat="server">
    ...
    private string path = HttpContext.Current.Server.MapPath("~/Content/blog");
    private string imgPath = System.Web.VirtualPathUtility.ToAbsolute("~/Content/blog");
    ...
    protected void lvFileList_ItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListViewItemType.DataItem)
        {
            ...
            lblLength.Text = ConvertKilobytesToMegabytes(((FileInfo)dataItem.DataItem).Length).ToString();
        }
    }

    public double ConvertKilobytesToMegabytes(long bytes)
    {
        return bytes / 1024f;
    }
                ...
                menu: 'myMenu'
					...
					function (action, el, pos) {
					    ...
					    if (action == "paste") {
					        ...
					        var source = '<a href="' + path + $(el).attr('id') + '">' + $(el).attr('id') + '</a>';
					        javascript: netBrowserDialog.insert(source);
					    } // if end
...
<body style="background: url(img/fading_background_19.png) repeat-x;background-color:#fff;">
                        ...
                        <asp:ListView runat="server" ID="lvFileList" OnItemDataBound="lvFileList_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblLength" Text="" runat="server"></asp:Label> mb
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:ListView>
